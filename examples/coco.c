...
{
<<<<<<< HEAD
    //char *train_images = "/home/brandonjabr/data/voc/test/train.txt";
    //char *train_images = "/home/brandonjabr/data/coco/train.txt";
...
<<<<<<< HEAD
    //list *plist = get_paths("/home/brandonjabr/data/people-art/test.txt");
    //list *plist = get_paths("/home/brandonjabr/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
